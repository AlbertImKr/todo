...
- [x]  **할일 조회**: 특정 할일의 상세 정보를 조회할 수 있습니다.
- [x]  **할일 목록 조회**:
    - [x]  **태그 별**: 태그를 기준으로 할일 목록을 조회할 수 있습니다.
    - [x]  **프로젝트 별**: 프로젝트를 기준으로 할일 목록을 조회할 수 있습니다.
    - [x]  **전체**: 모든 할일 목록을 조회할 수 있습니다.
- [x]  **할일 상태 변경**: 할일의 상태를 업데이트할 수 있습니다. (예: 미완료, 진행 중, 완료)
- [x]  **할일 우선순위 변경**: 할일의 우선순위를 업데이트할 수 있습니다. (예: low, medium,high)
- [x]  **태그 추가**: 할일에 태그를 추가할 수 있습니다.
- [x]  **태그 삭제**: 할일에서 태그를 삭제할 수 있습니다.
- [x]  **할일 알림 설정 업데이트**: 할일 기한 전 알림을 설정을 업데이트할 수 있습니다.
- [x]  **할일 알림 설정 삭제**: 할일 기한 전 알림을 설정을 삭제할 수 있습니다.
...
- [x]  **특정 그룹 삭제**: 특정 그룹을 삭제할 수 있습니다.
- [x]  **특정 그룹 상세 정보 조회**: 특정 그룹의 상세 정보를 조회할 수 있습니다.
- [x]  **특정 그룹에 포함된 유저 조회**: 특정 그룹에 포함된 유저를 가져올 수 있습니다.
- [x]  **특정 그룹에 유저 추가**: 특정 그룹에 유저를 추가할 수 있습니다.
- [x]  **특정 그룹에서 유저 삭제**: 특정 그룹에서 유저를 삭제할 수 있습니다.
- [x]  **특정 그룹에 할일 추가**: 특정 그룹에 할일을 추가할 수 있습니다.
- [x]  **특정 그룹에서 할일 삭제**: 특정 그룹에서 할일을 삭제할 수 있습니다.
- [x]  **특정 그룹의 할일 수정**: 특정 그룹의 할일을 수정할 수 있습니다.
- [x]  **특정 그룹의 할일 상태 변경**: 특정 그룹의 할일 상태를 변경할 수 있습니다.
- [x]  **특정 그룹의 할일 상세 정보 조회**: 특정 그룹의 할일 상세 정보를 조회할 수 있습니다.
- [x]  **특정 그룹 할일에 태그 추가**: 할일에 태그를 추가할 수 있습니다.
- [x]  **특정 그룹 할일에서 태그 삭제**: 할일에서 태그를 삭제할 수 있습니다.
- [x]  **특정 그룹 할일에 프로젝트 업데이트**: 할일의 프로젝트를 업데이트할 수 있습니다.
- [x]  **특정 그룹 할일 목록 조회**:
    - [x]  **프로젝트 별**: 프로젝트를 기준으로 할일 목록을 조회할 수 있습니다.
    - [x]  **전체**: 모든 할일 목록을 조회할 수 있습니다.
...
- [x]  **유저가 속한 모든 그룹 정보 조회**: 유저가 속한 모든 그룹 정보를 가져올 수 있습니다.
...
| `/todos/{id}/notification-settings` | DELETE      | 특정 할일의 알림을 삭제합니다.          | ✅  |
